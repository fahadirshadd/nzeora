...
//
//     final latestBlogPost = latestBlogPostFromJson(jsonString);

import 'dart:convert';

List<LatestBlogPost> latestBlogPostFromJson(String str) => List<LatestBlogPost>.from(json.decode(str).map((x) => LatestBlogPost.fromJson(x)));

String latestBlogPostToJson(List<LatestBlogPost> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class LatestBlogPost {
  ...
  factory LatestBlogPost.fromJson(Map<String, dynamic> json) => LatestBlogPost(
    id: json["id"],
