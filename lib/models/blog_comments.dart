...
//
//     final blogComments = blogCommentsFromJson(jsonString);

import 'dart:convert';

List<BlogComments> blogCommentsFromJson(String str) => List<BlogComments>.from(json.decode(str).map((x) => BlogComments.fromJson(x)));

String blogCommentsToJson(List<BlogComments> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
